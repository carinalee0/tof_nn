...
def train_model(model, epochs, train_loader, optimizer, scheduler):
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            torch.save(model.state_dict(), cwd + '/modelresults/model_v3.pth')
            torch.save(optimizer.state_dict(), cwd + '/modelresults/optimizer_v3.pth')
...
if __name__ == "__main__":
    train_model(fully_connected_model, 25, train_loader, optimizer, scheduler)
